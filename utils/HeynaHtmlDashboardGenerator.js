...
class HeynaHtmlDashboardGenerator {
    static async generate(options = {}) {
        ...
        const html = this.document({ metadata, summary, executionData, coverage, failureGroups, insights });

        fs.writeFileSync(outputPath, html, 'utf8');
        return outputPath;
    }

    static document({ metadata, summary, executionData, coverage, failureGroups, insights }) {
